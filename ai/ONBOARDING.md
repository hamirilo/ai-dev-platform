...
5. Django TemplateへIsland / htmxを接続・追加する場合は、Playbookの [DjangoとReact Islandsの接続](../playbook/playbooks/django-react-islands.md) に従う。見せ方だけの切替（tab、開閉、出し分け）とtemplate用の共通classは自前で書かず、UI Platformのものを使う。
